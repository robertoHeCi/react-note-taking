...
const LightIcon = () => {
  return <svg className="w-8 h-8 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
const EditIcon = () => {
  return <svg className="w-6 h-6 dark:text-gray-800 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
export { TextIcon, ImageIcon, CheckIcon, LightIcon, DarkIcon, EditIcon };